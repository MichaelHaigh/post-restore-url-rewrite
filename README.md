...
```text
actoolkit create script container-image-change post-restore-hook.sh -d "Script to change the container image path"
...
```text
actoolkit create hook 60c6990a-9d99-41a4-a7a5-3f8e19dff94e post-restore-image-rewrite 02def8ea-acab-4216-8236-132d42ae0dda -o post-restore -c alpine-astra-hook
...
```text
$ kubectl get -n demo deployment demo-deployment -o json | jq '.spec.template.spec.containers[].image'
...
```text
$ actoolkit restore -b 60c6990a-9d99-41a4-a7a5-3f8e19dff94e --snapshotID 5d076272-40ed-4c77-ad30-0677de370a78
